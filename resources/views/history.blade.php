...
@section('content')
                ...
                <div class="art-timeline art-gallery">
                        ...
                        <div class="art-a art-timeline-content">
                            ...
                            <div class="row">
                                <div class="col-6 col-lg-3">
                                    <img class="art-brand" src="{{ asset('img/brands/3.png') }}" alt="brand" height="50">
                                </div>
                            </div>
                    ...
                    <div class="art-timeline-item">
                        ...
                        <div class="art-a art-timeline-content">
                            ...
                            <div class="row">
                                <div class="col-6 col-lg-3">
                                    <img class="art-brand" src="{{ asset('img/brands/2.png') }}" alt="brand" width="100">
                                </div>
                            </div>
                ...
                <div class="art-timeline">
                    ...
                    <div class="art-timeline-item">
                        ...
                        <div class="art-a art-timeline-content">
                            ...
                            <div class="row">
                                <div class="col-6 col-lg-3">
                                    <img class="art-brand" src="{{ asset('img/brands/logo-kominfo.png') }}" alt="Dinas Kominfo" style="max-width: 100%; height: auto;">
                                </div>
                            </div>
                        
                            <p>Sebagai bagian dari Program Kuliah Magang Mahasiswa (KMM), saya berkontribusi dalam pengembangan sistem berbasis web untuk memantau dan mengelola data stunting di Kabupaten Karanganyar.</p>
                        
                            <ul>
                                <li>Mengembangkan antarmuka responsif menggunakan Vue.js (dashboard, entri data, modul pelaporan)</li>
                                <li>Mendesain arsitektur database (MySQL) dan RESTful APIs (PHP/Laravel) untuk manajemen data stunting</li>
                    ...
                    <div class="art-timeline-item">
                        ...
                        <div class="art-a art-timeline-content">
                            ...
                            <p>Berkontribusi dalam pengembangan aplikasi monitoring berbasis web untuk Dinas Komunikasi dan Informatika Kabupaten Karanganyar.</p>
                        
                            <ul>
                                <li>Mengembangkan dashboard interaktif untuk memantau program dan kegiatan pemerintah secara real-time</li>
                                <li>Berkolaborasi dengan tim backend dalam integrasi API untuk presentasi data yang dinamis</li>
                                <li>Membangun modul pelaporan program dan kegiatan yang mudah diakses dan terstruktur</li>
                                <li>Mengimplementasikan desain responsif untuk tampilan optimal di berbagai perangkat</li>
                    ...
                    <div class="art-timeline-item">
                        ...
                        <div class="art-a art-timeline-content">
                            ...
                            <div class="row">
                                <div class="col-6 col-lg-3">
                                    <img class="art-brand" src="{{ asset('img/brands/logo-surakarta.png') }}" alt="brand" style="max-width: 100%; height: auto;">
                                </div>
                            </div>                                                            
                        
                            <p>Sebagai bagian dari Program Pembelajaran Berbasis Proyek (PBL), terlibat dalam pengembangan aplikasi persuratan untuk Kecamatan Banjarsari.</p>
                        
                            <ul>
                                <li>Mengembangkan antarmuka pengguna yang responsif dan menarik menggunakan framework Vue.js</li>
                                <li>Menyelaraskan antarmuka pengguna dengan desain dan spesifikasi produk</li>
                                <li>Berkolaborasi dengan tim pengembangan backend untuk mengintegrasikan logika bisnis dengan antarmuka pengguna</li>
    ...
    <div class="container-fluid">
        <footer>
            <div class="art-copy">© 2024 Dimas Wahyu Sulistyo</div>
            <div>
                Template author:&nbsp;
                <a href="https://themeforest.net/user/millerdigitaldesign" target="_blank" data-no-swup>Nazar Miller</a>
            </div>
        </footer>
    </div>
@endsection