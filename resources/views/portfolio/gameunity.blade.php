@extends('layouts.app') @section('title', 'TLOS - Game Unity')
@section('content')
    ...
    <div class="row p-30-0">
        ...
        <div class="col-lg-12">
            <div class="art-a art-project-cover">
                <a
                    ...
                    href="{{ asset('img/works/game-1.jpg') }}"
        ...
        <div class="col-lg-8">
            <div class="art-a art-card art-fluid-card">
                ...
                <div class="mb-15">The Legend of Soldier adalah permainan aksi petualangan yang
                    dikembangkan menggunakan Unity Engine. Pemain mengambil peran sebagai seorang
                    prajurit yang harus menjelajahi dunia fantasi, mengumpulkan pedang legendaris,
                    dan mengalahkan musuh dalam waktu yang telah ditentukan. Game ini menampilkan
                    mekanik gameplay yang menarik, grafis 3D yang imersif, dan sistem pencarian item
                    yang menantang.</div>
            </div>
        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="art-a art-testimonial">
                            <div class="testimonial-body">
                                ...
                                <div class="mb-15">Sebagai Game Developer, saya bertanggung jawab dalam
                                    pengembangan mekanik gameplay, implementasi sistem pencarian item, dan integrasi
                                    seluruh komponen game. Saya memastikan pengalaman bermain yang smooth dan
                                    engaging bagi pemain.</div>
                            </div>
                        </div>
                    </div>
                </div>
