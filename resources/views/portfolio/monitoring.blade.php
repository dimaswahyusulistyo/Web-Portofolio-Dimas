@extends('layouts.app') @section('title', 'DISKOMINFO Karanganyar - Monitoring
Program & Kegiatan') @section('content')
    ...
    <div class="row p-30-0">
        ...
        <div class="col-lg-12">
            <div class="art-a art-project-cover">
                <a
                    ...
                    href="{{ asset('img/works/monitoring-cover.jpg') }}"
                    class="art-portfolio-item-frame art-horizontal">
                    <img
                        src="{{ asset('img/works/monitoring-cover.jpg') }}"
                        alt="Dashboard Monitoring DISKOMINFO">
        ...
        <div class="col-lg-8">
            <div class="art-a art-card art-fluid-card">
                ...
                <div class="mb-15">
                    <p>Mengembangkan aplikasi berbasis web dan mobile untuk memantau program dan
                        kegiatan DISKOMINFO Karanganyar secara real-time. Sistem ini dirancang untuk
                        meningkatkan efisiensi dan transparansi dalam pelaksanaan program dan kegiatan
                        dinas.</p>
        ...
        <div class="col-lg-4">
            <div class="art-a art-card">
                        ...
                        <li>
                            ...
                            <span>
                                <a
                                    ...
                                    target="_blank"
                                    data-no-swup="data-no-swup">Karanganyar, Jawa Tengah</a>
                            </span>
                        </li>
                        <li>
                            <h6>Pengguna:</h6>
                ...
                <a
                    href="https://gitd3ti.vokasi.uns.ac.id/dimaswahyusulistyo/web-monitoring"
                    target="_blank"
                    data-no-swup="data-no-swup"
        ...
        <div class="art-grid art-grid-2-col art-gallery">
            <div class="art-grid-item">
                <a
                    data-fancybox="gallery"
                    data-no-swup="data-no-swup"
                    href="{{ asset('img/works/monitoring-1.jpg') }}"
            ...
            <div class="art-grid-item">
                <a
                    data-fancybox="gallery"
                    data-no-swup="data-no-swup"
                    href="{{ asset('img/works/monitoring-4.jpg') }}"
                    class="art-a art-portfolio-item-frame art-vertical">
                    <img
                        src="{{ asset('img/works/monitoring-4.jpg') }}"
                    ...
                    <div class="swiper-slide">
                        <div class="art-a art-testimonial">
                            <div class="testimonial-body">
                                ...
                                <div class="mb-15">Sebagai Frontend Developer, bertanggung jawab dalam
                                    pengembangan antarmuka pengguna untuk aplikasi Monitoring. Merancang tampilan
                                    yang responsif dan interaktif menggunakan Vue.js.</div>
                            </div>
                        </div>
                    </div>
                </div>
